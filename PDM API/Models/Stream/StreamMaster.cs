...
{
    [Table("STREAM_MASTER", Schema = "PDM")]
    public class StreamMaster
    {
        [JsonProperty("STREAM_ID")]
        public double? STREAM_ID { get; set; }
        ...
        [JsonProperty("STREAM_V_START_DATE")]
        public DateTime? STREAM_V_START_DATE { get; set; }
        [JsonProperty("STREAM_V_END_DATE")]
        public DateTime? STREAM_V_END_DATE { get; set; }
