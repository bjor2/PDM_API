...
{
    [Table("WB_INJ_DAY", Schema = "PDM")]
    public class WellBoreInjDayCompact
    {
        ...
        [JsonProperty("WELL_INJ_VOL_SM3")]
        public IEnumerable<double?> WELL_INJ_VOL_SM3 { get; set; }
        [JsonProperty("WBI_INJ_VOL_SM3")]
        public IEnumerable<double?> WBI_INJ_VOL_SM3 { get; set; }
        [JsonProperty("WBI_GAS_VOL_SM3")]
        public IEnumerable<double?> WBI_GAS_VOL_SM3 { get; set; }
        [JsonProperty("PERF_INJ_VOL_SM3")]
        public IEnumerable<double?> PERF_INJ_VOL_SM3 { get; set; }
        ...
        [JsonProperty("WBI_CHOKE_UOM")]
        public IEnumerable<string> WBI_CHOKE_UOM { get; set; }
