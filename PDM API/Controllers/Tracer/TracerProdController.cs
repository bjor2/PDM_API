...
namespace PDM_API.Controllers
{
    ...
    public class TracerProdController : ControllerBase
    {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(TracerProd), 200)]
        public async Task<IActionResult> GetTracerProd(int? skip, int? top, string columns, DateTime? DATEPRD, string WELL_BORE_CODE)
        {
