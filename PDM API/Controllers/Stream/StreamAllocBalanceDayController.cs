...
namespace PDM_API.Controllers.Stream
{
    ...
    public class StreamAllocBalanceDayController : ControllerBase
    {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(StreamAllocBalanceDay), 200)]
        public async Task<IActionResult> GetStreamAllocBalanceDay(int? skip, int? top, string columns)
        {
             ...
             */
            StreamAllocBalanceDay obj = new StreamAllocBalanceDay();
            ...
            var result = _db.StreamAllocBalanceDay
                .Where(e => (true))
                .Skip(s)
                .Take(t)
                .Select("new(" + columns + ")");
